...
• Amazon：35% 營收來自推薦引擎  
• YouTube：70% 觀看時間由推薦驅動  
• Spotify：演算法推薦提升用戶留存 25%

**核心挑戰**
❌ 26,000 部電影 × 138,000 位使用者 = 36 億種可能  
✅ 如何從海量選擇中找到「最適合你」的 10 部？
...
**實務挑戰**
• **冷啟動問題**：34.5% 電影評分≤5（如何推薦冷門電影？）  
• **長尾效應**：前 20% 用戶貢獻 63% 評分（如何服務剩下的 80%？）  
• **稀疏性問題**：99.5% 的使用者-電影組合是空白（如何填補空缺？）  
• **效能需求**：20M 筆資料如何在秒級完成推薦？
