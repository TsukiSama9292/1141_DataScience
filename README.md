...
- **策略**：對評分套用指數衰減權重，半衰期設為 500 天（使用與實驗6相同的 SVD 128維 + KNN 50鄰居配置）
  ...
  ```
- **結果**：
  - Hit Rate **下降**至 61.6%（比實驗6差 -7.8%）
  - NDCG **下降**至 0.4740（比實驗6差 -10.2%）
  - RMSE **上升**至 1.0312（比實驗6差 +5.7%）
- **分析**：
...
3. **負面結果的學術價值** ⚠️：
   - **時間衰減無效**：實驗7顯示時間衰減使 Hit Rate 下降 7.8%、RMSE 上升 5.7%，證明電影品味具有長期穩定性，與新聞/商品推薦不同
